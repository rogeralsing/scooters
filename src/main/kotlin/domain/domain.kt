...
fun runSimulation(fleetManagerCapacity: Int, fleetEngineerCapacity: Int, scooters: IntArray): Int {
    when {
        ...
        scooters.any { it !in 0..1000 } -> throw IllegalArgumentException("scooters elements must be between 0 and 1000")
            ...
            val speculativeResult = districts.sumBy {
                it.requiredEngineers
            }
            ...
            // this is a single iteration over the sequence, we get the delta
            // between first and second of the pair.
            // this delta is subtracted from the speculative result, this give us
            // the result when the FM is in this district
